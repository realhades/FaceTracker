...
public class HappyFaceTest extends GraphicOverlay.Graphic {
    ...
    HappyFaceTest(GraphicOverlay overlay) {
            super(overlay);
...
//            Drawable myImage = ResourcesCompat.getDrawable(.getResources(), R.drawable.smile, null);
            ...
            Log.i("FaceY", String.valueOf(face.getEulerY()));
            Log.i("FaceZ", String.valueOf(face.getEulerZ()));
